    ...
    public Boolean answeredBy (Actor actor){
        try{
            Target productoEncontrado = Target.the("el producto '"+ nombreProducto + "' en la lista")
                    .locatedBy("//td[text()='" + nombreProducto + "']");// se crea un "target dinamico" lo que hace es usar el xpath del target referencaido para poder sustituir su pocicio "{0}" con el nombre del producto
